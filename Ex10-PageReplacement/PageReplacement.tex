...
%Assignment name
\subsection*{\center{\textbf{Lab Exercise 10: Implementation of Page Replacement Algorithms}}}
...
\flushleft{Q.To write a C program to implement the page replacement algorithms (FIFO, Optimal, LRU
and LFU) using linked list.}
\lstinputlisting[language=C]{LinkedList.h}
\lstinputlisting[language=C,lastline=673]{PageReplacement.c}
%Output
\flushleft{\textbf{\emph{Output:}}}
\lstinputlisting[language=C,firstline=677,lastline=880]{PageReplacement.c}
\hrule
\vspace{10mm}
